...
# The "url" variable in the script can be changed to the use the station ID of your choice. Go to
# https://tidesandcurrents.noaa.gov/ for more info and to search for station IDs.
